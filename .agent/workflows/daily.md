...
### 1-5. プロンプト・マニフェスト (Prompt Manifest)

Antigravity の思考プロセスは、以下のプロンプトファイルによって定義されています。これらは、システムの「魂」の設計図です。

-   **Research Phase**: [`prompts/research.yaml`](file:///home/kafka/2511youtuber/v3/yt3/prompts/research.yaml)
    -   情報の収集、選別、文脈化の指針。
-   **Content Phase**: [`prompts/content.yaml`](file:///home/kafka/2511youtuber/v3/yt3/prompts/content.yaml)
    -   キャラクターの口調、対話構造、脚本のトーン＆マナー。
-   **Critic Phase**: [`prompts/critic.yaml`](file:///home/kafka/2511youtuber/v3/yt3/prompts/critic.yaml)
    -   自己批判、品質保証、論理的整合性のチェック。
-   **Memory Phase**: [`prompts/memory.yaml`](file:///home/kafka/2511youtuber/v3/yt3/prompts/memory.yaml)
    -   過去の文脈の保持、長期的なナラティブの構築。
