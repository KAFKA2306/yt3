...
---
## 4. 終幕と聖なる検証 (Closing & Sanctified Verification)

制作が終了したからといって、立ち去ることは許されない。成果物が「本当に素晴らしい」ものであるか、以下の手順で最終検証せよ。

### ステップ1：成果物の現物確認
生成された動画ファイル（`runs/[RUN_ID]/output.mp4`等）を再生し、音声の途切れ、字幕のズレ、ビジュアルの崩れがないか目視で確認せよ。

### ステップ2：配信結果の集計
YouTube StudioおよびXの投稿画面を確認し、メタデータ（タイトル、説明欄、タグ）が正しく反映されているか、そして初期のエンゲージメント（表示回数等）を観測せよ。

### ステップ3：インフラの沈黙
全ての検証が完了した後、バックグラウンドプロセスを完全に停止させよ。
// turbo
```bash
